    ...
    <ExportPage group={e.group} title={e.name} lede={e.lede}>
      ...
      <PropTable
        ...
        rows={[
          ...
          { name: 'GluedBookBinding', type: 'class', desc: 'The glued spine: one smooth cover mesh with modular softness, pages glued to the spine. See its dedicated page for GluedSetup.' },
